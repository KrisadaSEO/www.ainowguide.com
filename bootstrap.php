...
function site_app(bool $refresh = false): array
{
    ...
    if ($refresh || $app === null) {
        ...
        $federation = site_load_json_file('config/federation.json');
        ...
        $thaiResources = site_load_json_file('content/thai/resources.json');
        $federationResources = site_load_json_file('content/federation/resources.json');
