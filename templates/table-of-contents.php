...
<header class="directory-hero">
    <div class="category-hero__label">Table of Contents</div>
    <h1><?= site_e($record['title'] ?? 'Table of Contents') ?></h1>
...
<?php else: ?>
    ...
    <div class="category-section">
        <h2 class="category-section__heading">
            <a href="/table-of-contents/<?= site_e($category['slug'] ?? '') ?>/" style="color: inherit; text-decoration: none;">
    ...
    <?php if (empty($topCategories)): ?>
        <p class="text-muted">The table of contents is being built. Check back soon.</p>
    <?php endif; ?>
